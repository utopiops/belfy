...
// @Success 200 {} nil "ok"
// @Router /bitbucket/environment/name/:env_name/application/name/:app_Name/settings [put]
func (controller *BitbucketController) UpdateApplicationProject(settingsStore stores.SettingsStore) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err = settingsStore.UpdateBitbucketApplicationSettings(noContext, accountID, environmentName, applicationName, setSettingsDto.IntegrationName, setSettingsDto.RepoFullName)
