...
function validateNavbar(navbar: unknown, validPages: string[]): navbar is NavbarConfig {
  ...
  const { items } = navbar as NavbarConfig;
...
function validatePageOverrides(pageOverrides: unknown, validPages: string[]): pageOverrides is PageOverrideConfig {
  ...
  const pageOverrideKeys = Object.keys(result);
...
function validate(parsedData: { entities: unknown[]; navbar: unknown; pageOverrides: unknown }): 
{ entities: Entity[]; navbar: NavbarConfig; pageOverrides: PageOverrideConfig } | null {
  ...
  return { entities: entities as Entity[], navbar: navbar as NavbarConfig, pageOverrides: pageOverrides as PageOverrideConfig };
}
