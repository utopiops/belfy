...
const supportedJobs = [
  constants.jobPaths.deployACMCertificate,
  constants.jobPaths.destroyACMCertificate,
];

class ACMCertificateHandler {
  ...
  handle = async (jobDetails, jobPath) => {
    ...
    try {
      switch (jobPath) {
        case constants.jobPaths.deployACMCertificate:
          await this.deployACMCertificate(jobDetails);
          break;
        case constants.jobPaths.destroyACMCertificate:
  ...
  deployACMCertificate = async (jobDetails) => {
    ...
    try {
      ...
      await sslTlsCertificateService.sendCertificateDeploymentState({ id: jobDetails.userId, accountId: jobDetails.accountId }, jobDetails.details.environmentName, jobDetails.details.identifier, 'deployed', jobDetails.jobId);
    } catch (e) {
      console.error(e);
      const jobResult = {
        jobId: jobDetails.jobId,
      ...
      console.log(`jobResult: `, jobResult);
      await sslTlsCertificateService.sendCertificateDeploymentState({ id: jobDetails.userId, accountId: jobDetails.accountId }, jobDetails.details.environmentName, jobDetails.details.identifier, 'deploy_failed', jobDetails.jobId);
    }
  }
  ...
  destroyACMCertificate = async (jobDetails) => {
    ...
    try {
      ...
      console.log(`jobResult: `, jobResult);
      await sslTlsCertificateService.sendCertificateDeploymentState({ id: jobDetails.userId, accountId: jobDetails.accountId }, jobDetails.details.environmentName, jobDetails.details.identifier, 'destroyed', jobDetails.jobId);
    } catch (e) {
      console.log(e);
      const jobResult = {
        jobId: jobDetails.jobId,
      ...
      console.log(`jobResult: `, jobResult);
      await sslTlsCertificateService.sendCertificateDeploymentState({ id: jobDetails.userId, accountId: jobDetails.accountId }, jobDetails.details.environmentName, jobDetails.details.identifier, 'destroy_failed', jobDetails.jobId);
    }
  }
...
module.exports = ACMCertificateHandler;