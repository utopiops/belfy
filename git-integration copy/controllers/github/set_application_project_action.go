...
// @Success 200 {} nil "ok"
// @Router /github/environment/name/:env_name/application/name/:app_Name/settings [post]
func (controller *GithubController) SetApplicationProject(settingsStore stores.SettingsStore) gin.HandlerFunc {
