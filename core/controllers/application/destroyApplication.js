...
async function destroyApplication(req, res) {
  const validationSchema = yup.object().shape({
    ...
    return await ApplicationService.tfActionApplication('destroy', accountId, userId, username, environmentId, environmentName, applicationName, req.body, credentials, providerDetails, domain, headers);
  };
