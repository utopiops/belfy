...
async function deployKubernetesCluster(req, res) {
    ...
    const providerDetails = provider.backend
		...
		return await KubernetesClusterService.tfActionKubernetes('deploy', accountId, userId, environmentId, environmentName, clusterName, credentials, providerDetails, variables, headers);
	};
...
exports.handler = deployKubernetesCluster;
