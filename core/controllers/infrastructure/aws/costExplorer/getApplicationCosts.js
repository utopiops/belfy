...
const ApplicationModel = require("../../../../db/models/application/application");

async function getApplicationCosts(req, res) {
  ...
  const handle = async () => {
    ...
    const concatenatedName = `${environmentName}-${applicationName}`;
    ...
    const Filter = { Tags: {
      Key: 'UTOPIOPS_APPLICATION',
      Values: [concatenatedName]
    }}
...
exports.handler = getApplicationCosts;